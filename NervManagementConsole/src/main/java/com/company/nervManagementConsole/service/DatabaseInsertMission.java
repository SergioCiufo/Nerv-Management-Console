...
public class DatabaseInsertMission {
	...
	public DatabaseInsertMission(MissionDao missionDao, Connection connection) {
		super();
		this.missionDao = missionDao;
		this.connection = connection;	
	}
	
	public void createMission(String name, String description, Integer participantsMax, Integer levelMin,
	...
	public void createMissions() throws SQLException {
	    createMission("Angel Attack",
	    ...
	    createMission("Showdown in Tokyo-3",
	    ...
	    createMission("Both of You, Dance Like You Want to Win!",
	    ...
	    createMission("The Day Tokyo-3 Stood Still",
	    ...
	    createMission("She Said, Don't Make Others Suffer",
	    ...
	    createMission("Lilliputian Hitcher",
	    ...
	    createMission("Splitting of the Breast",
	    ...
	    createMission("He Was Aware That He Was Still a Child",
	    ...
	    createMission("Take Care of Yourself",
